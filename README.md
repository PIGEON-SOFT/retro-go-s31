...
| --- | --- |
| <img src="https://raw.githubusercontent.com/PIGEON-SOFT/retro-go-s31/main/docs/media/retro-go-s31-game-list.jpg" alt="Retro-Go S31 game list" width="420"> | <img src="https://raw.githubusercontent.com/PIGEON-SOFT/retro-go-s31/main/docs/media/retro-go-s31-controls.jpg" alt="Retro-Go S31 controls" width="420"> |

[![Retro-Go S31 demo video](https://raw.githubusercontent.com/PIGEON-SOFT/retro-go-s31/main/docs/media/retro-go-s31-controls.jpg)](https://github.com/PIGEON-SOFT/retro-go-s31/releases/download/v0.1.1/retro-go-s31-demo.mp4)

[查看演示视频 / 下载 MP4](https://github.com/PIGEON-SOFT/retro-go-s31/releases/download/v0.1.1/retro-go-s31-demo.mp4)
...
- 2026 年 6 月 1 日已修复 GBA 游戏无法正常写入备份存档的问题。
...
oowu / wu0uw 的更新。GBA 备份存档问题已在 2026 年 6 月 1 日修复，欢迎社区
开发者继续提交 issue、测试日志和改进 PR。
...
[Watch / download the MP4 demo](https://github.com/PIGEON-SOFT/retro-go-s31/releases/download/v0.1.1/retro-go-s31-demo.mp4)
...
- GBA backup save writes were fixed on June 1, 2026.
...
gamepad support come from oowu / wu0uw's update. GBA backup save writes were
fixed on June 1, 2026. Issues, test logs and pull requests are welcome.

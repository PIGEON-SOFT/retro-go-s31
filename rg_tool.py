...
DEFAULT_TARGET = os.getenv("RG_TOOL_TARGET", "esp32-s31-korvo-1")
DEFAULT_BAUD = os.getenv("RG_TOOL_BAUD", "1500000")
DEFAULT_PORT = os.getenv("RG_TOOL_PORT") or autodetect_port()
DEFAULT_APPS = os.getenv("RG_TOOL_APPS", "launcher retro-core gbsp")
PROJECT_NAME = os.getenv("PROJECT_NAME", "Retro-Go-S31")
...
def build_image(output_file, apps, img_format="esp32", fatsize=0):
    ...
    elif img_format == "esp32p4" or img_format == "esp32s31":

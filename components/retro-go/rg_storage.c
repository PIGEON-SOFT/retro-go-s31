...
void rg_storage_init(void)
{
    ...
    slot_config.width = 1;
#ifdef RG_STORAGE_SDMMC_INTERNAL_PULLUPS
...
#if defined(RG_GPIO_SDMMC_D1) && defined(RG_GPIO_SDMMC_D2) && defined(RG_GPIO_SDMMC_D3) && !defined(RG_STORAGE_SDMMC_FORCE_1BIT)
    slot_config.width = 4;

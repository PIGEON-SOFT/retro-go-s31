...
void gw_main(void)
{
    ...
    if (!rom_status)
    {
        rg_gui_alert("Unsupported Game & Watch ROM",
                     "This core needs .gw files generated by LCD-Game-Shrinker. "
                     "The .mgw files on this SD card are a different romart/Madrigal format.");
